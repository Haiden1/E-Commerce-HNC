...
<?php
  ...
  // insert into [TableName] [Fieldnames] Values [values to insert],'$NoTracks','$Label','$ReleaseYear','$ArtistName'
//   ,NoTracks,Label,Release_Year,Artist_name
  $Query = "insert into CDsAuto (CD_title, NoTracks,Release_Year,Label,Artist_name) values ('$CDTitle','$NoTracks','$ReleaseYear','$Label','$ArtistName')";
